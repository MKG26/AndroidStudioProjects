...
@Composable
fun GreetingText(name: String,from: String,to: String, modifier: Modifier = Modifier){
    Column {
        Text(
            text = name,
            fontSize = 24.sp,
...
@Composable
fun GreetingImage(name: String,from: String,to: String, modifier: Modifier = Modifier) {
